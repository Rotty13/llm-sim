...
Defines schemas for city.yaml, personas.yaml, world.yaml, names.yaml, and places.yaml.

Key Functions:
- validate_city_config: Validate city configuration files.
- validate_personas_config: Validate personas configuration files.
- validate_world_config: Validate world configuration files.
- validate_names_config: Validate names configuration files.
- validate_place_connectivity: Validate place connectivity and relationships.

LLM Usage:
- None directly; validation logic may be used by modules that interact with LLMs.
