"""
Functional Purpose: Generates diverse first and last names for personas using LLM.
Description: Uses LLM to create authentic names for simulation entities, with batch and exclusion logic.
