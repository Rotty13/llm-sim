"""
Functional Purpose: Generates LLM prompts from review files for prompt engineering.
Description: Reads review files, uses LLM to create prompts, and saves output.
...
llm = LLM(gen_model="llama3.1:8b-instruct-q4_0", caller="prompt_from_review")
llm.temperature = 0.7
