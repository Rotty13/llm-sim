"""
Functional Purpose: Creates personas for a city simulation using LLM.
Description: Uses LLM and templates to generate realistic personas with names, jobs, bios, and goals.
