"""
Functional Purpose: Iteratively improves text responses with fulfillment checks using LLM.
Description: Uses LLM to improve responses and checks if user requests are fulfilled, with retry logic.
...
llm = LLM(gen_model="llama3.1:8b-instruct-q4_0", caller="iterate_response_hf")
llm.temperature = 0.9
