"""
Functional Purpose: Processes JSON files with LLM based on user/system prompts.
Description: Loads JSON, sends to LLM for improvement, and saves results.
...
llm = LLM(gen_model="llama3.1:8b-instruct-q4_0", caller="llm_json_file")
llm.temperature = 0.9
